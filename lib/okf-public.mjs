...
export async function validatePublicOkf({ rootDir, manifestPath, outputDir }) {
  ...
  verifyChecksumFile(checksummed, files.get('CHECKSUMS.sha256'));
  ...
  return { conceptCount: conceptPaths.size, fileCount: actualPaths.length };
}
