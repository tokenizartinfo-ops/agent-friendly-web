...
export const COMIC_HOME_COPY = Object.freeze({
  es: {
    ...
    primary: 'Descubrir qué entiende un agente', secondary: 'Abrir el archivo del futuro',
    archiveEyebrow: 'Archivo del futuro', archiveTitle: 'Cada capacidad tiene un expediente, una evidencia y un límite.',
    archiveIntro: 'Los documentos pueden multiplicarse sin cambiar la ruta F0-F5. Abrí cada ficha para ver qué está realmente publicado y qué todavía conserva un gate.', open: 'Abrir expediente', files: comicFiles.es,
  },
  en: {
    ...
    primary: 'Discover what an agent understands', secondary: 'Open the archive of the future',
    archiveEyebrow: 'Archive of the future', archiveTitle: 'Every capability has a file, evidence and a boundary.',
    archiveIntro: 'Documents can grow without changing the F0-F5 path. Open each file to see what is truly published and what still has a gate.', open: 'Open file', files: comicFiles.en,
  },
  pt: {
    ...
    primary: 'Descobrir o que um agente entende', secondary: 'Abrir o arquivo do futuro',
    archiveEyebrow: 'Arquivo do futuro', archiveTitle: 'Cada capacidade possui um dossiê, uma evidência e um limite.',
    archiveIntro: 'Os documentos podem crescer sem alterar a rota F0-F5. Abra cada ficha para ver o que está publicado e o que ainda possui um gate.', open: 'Abrir dossiê', files: comicFiles.pt,
  },
});
