...
const SOURCE_TITLES = Object.freeze({
  en: { overview: 'Complete site map', methodology: 'AF-0 to AF-5 methodology', audit: 'Public read-only auditor', aeo: 'AEO and crawler policy', registry: 'Public Registry', intake: 'Preparation assistant', expediente: 'Private dossier', okf: 'Open knowledge OKF', cli: 'Read-only CLI', tokenizart: 'Tokenizart case', faq: 'Frequently asked questions', readiness: 'Capability manifest', security: 'Security policy' },
...
function makeFaqTurn(entry, mode, locale = 'es') {
  ...
  return {
    ...
    quick_replies: [],
    sources: [localizedSource('faq', locale)],
    next_context: {
      topic: `faq:${entry.id}`,
      mode: answerMode,
      pending_follow_up: null,
