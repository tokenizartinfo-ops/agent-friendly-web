export const SHARED_COPY = Object.freeze({
  es: {
    ...
    nav: {
      audit: 'Auditar', guide: 'Guía', faq: 'Preguntas', aeo: 'AEO', sectors: 'Sectores', evolution: 'Evolución',
    ...
    footer: {
      ...
      audit: 'Auditar un sitio', guide: 'Guía pública', faq: 'Preguntas frecuentes', aeo: 'AEO y crawlers', sectors: 'Soluciones por sector',
      ...
      siteMap: 'Mapa completo', privacy: 'Privacidad', dossier: 'Mi expediente', security: 'Seguridad', repository: 'Repositorio',
  ...
  en: {
    ...
    nav: {
      audit: 'Audit', guide: 'Guide', faq: 'FAQ', aeo: 'AEO', sectors: 'Sectors', evolution: 'Evolution',
    ...
    footer: {
      ...
      audit: 'Audit a website', guide: 'Public guide', faq: 'Frequently asked questions', aeo: 'AEO and crawlers', sectors: 'Sector solutions',
      ...
      siteMap: 'Complete site map', privacy: 'Privacy', dossier: 'My dossier', security: 'Security', repository: 'Repository',
  ...
  pt: {
    ...
    language: { label: 'Idioma' },
    nav: {
      audit: 'Auditar', guide: 'Guia', faq: 'Perguntas', aeo: 'AEO', sectors: 'Setores', evolution: 'Evolução',
    ...
    footer: {
      ...
      audit: 'Auditar um site', guide: 'Guia público', faq: 'Perguntas frequentes', aeo: 'AEO e crawlers', sectors: 'Soluções por setor',
      ...
      siteMap: 'Mapa completo', privacy: 'Privacidade', dossier: 'Meu dossiê', security: 'Segurança', repository: 'Repositório',
