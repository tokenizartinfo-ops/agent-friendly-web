...
En el track de privacidad, Gate 6D.4D quedo cerrado el 2026-09-05 despues de una unica prueba humana con datos propios. La evidencia agregada confirma borrado y saneamiento, mientras el switch del piloto y los flags de contacto real, derechos publicos, retencion y novedades volvieron a `false`. El siguiente gate de ese track es exclusivamente documental y de politica: identidad juridica, jurisdicciones, responsable de tratamiento, copy, retencion, canal de derechos y soporte antes de cualquier dato de terceros. Email recurrente, CRM operativo, pagos y toda capacidad A2A transaccional siguen diferidos.
