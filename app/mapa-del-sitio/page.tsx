...
const machineResources = [
  ...
  { name: 'Traction F1 contract', detail: 'Regla local determinista; no guarda datos ni activa contacto, precios, propuestas o pagos.', href: '/.well-known/traction-f1-contract.json', icon: Braces },
...
const roadmap = [
  ...
  ['Traccion F1', 'documented', 'Regla determinista documentada; no hay scoring automatico de personas, outreach, precios activos, propuestas ni pagos.'],
