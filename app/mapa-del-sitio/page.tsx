...
const machineResources = [
  ...
  { name: 'Email operations contract', detail: 'Estado agregado: entrada verificada y salida todavia deshabilitada.', href: '/.well-known/email-operations-contract.json', icon: Braces },
  ...
  { name: 'Email outbound canary contract', detail: 'Proveedor seleccionado y preflight local; dominio emisor y envio siguen OFF.', href: '/.well-known/email-outbound-canary-contract.json', icon: Braces },
...
const roadmap = [
  ...
  ['Correo operativo', 'documented', 'Entrada verificada; Cloudflare Email Service seleccionado para salida, todavia sin dominio emisor, binding ni envio.'],
