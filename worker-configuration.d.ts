/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=canary --env-interface=CloudflareEnv` (hash: e61ef503c0d66293c095b88827e083cb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "AFW_CANARY_DIAGNOSTICS_ENABLED" | "AFW_REMOTE_DEPLOY_ENABLED" | "AFW_EMAIL_REVIEW_READY_ENABLED" | "AFW_SYNTHETIC_CONTACT_ENABLED" | "AFW_SYNTHETIC_CONTACT_TURNSTILE_SITE_KEY" | "AFW_SYNTHETIC_CONTACT_TURNSTILE_SECRET">> {}
}
