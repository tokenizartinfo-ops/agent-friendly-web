/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=canary --env-interface=CloudflareEnv` (hash: dd3f11b4aa682bf18788c4a60d45e9b2)
