/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=canary --env-interface=CloudflareEnv` (hash: 516fd839e7df82bbff1b3cb6217fcebe)
