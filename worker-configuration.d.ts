/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=canary --env-interface=CloudflareEnv` (hash: dc02f2fc61cd3d3d803fa67638b13a53)
