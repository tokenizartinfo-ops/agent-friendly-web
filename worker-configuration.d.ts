/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env canary --env-interface CloudflareEnv` (hash: 5b7b163ddbe0e17a3191a4402ac1375a)
// Runtime types generated with workerd@1.20260515.1 2026-09-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ACCESS_TEAM_DOMAIN: "replace-before-remote-deploy.cloudflareaccess.com";
	ACCESS_AUD: "replace-before-remote-deploy";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "AFW_REMOTE_DEPLOY_ENABLED">> {}
}
